...
export default function Activites() {
    ...
    const { user } = useAuth();
    const { data: actData, deleteData, insertData, updateData } = useFirestore<IActivity>();
    ...
    return (
        <div className="h-screen flex md:flex-row flex-col gap-[1rem] p-[1rem] bg-[url('https://res.cloudinary.com/dfreeafbl/image/upload/v1757946836/cloudy-winter_iprjgv.png')]">
            ...
            <div className="flex flex-col gap-[1rem] md:w-3/4 w-full">
                <div className="p-[1rem] h-[90%] border border-white overflow-y-auto rounded-[1rem] backdrop-blur-sm backdrop-brightness-75">
